document.addEventListener("DOMContentLoaded", function() {
    ...
    function startSlider() {
        intervalId = setInterval(nextSlide, 5000); // Elke 5 seconden naar de volgende slide
    }

    // Pauzeer automatisch schuiven bij het hoveren over de slider
    slider.addEventListener('mouseover', function() {
        clearInterval(intervalId); // Stop de interval
    });

    // Hervat automatisch schuiven wanneer de muis de slider verlaat
